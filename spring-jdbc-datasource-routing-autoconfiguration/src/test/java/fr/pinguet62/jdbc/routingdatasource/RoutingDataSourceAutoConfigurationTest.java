...
import static fr.pinguet62.jdbc.routingdatasource.RoutingDataSourceAutoConfigurationTest.CustomerConfigTest.CustomerDataSourceConfig;
import static fr.pinguet62.jdbc.routingdatasource.RoutingDataSourceAutoConfigurationTest.CustomerConfigTest.CustomerDataSourceConfig.MOCK;
...
class RoutingDataSourceAutoConfigurationTest {
    ...
    class CustomerConfigTest {
        ...
        @Test
        void useCustom() {
            assertThat(dataSource, Matchers.is(MOCK));
        }
    }
}
